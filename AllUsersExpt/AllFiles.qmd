---
title: Reference Controls from Expt Files From All Users
date: today
---
...
InPath <- file.path("F:")
OutPath <- file.path("C:", "Users", "12692", "Desktop", "Storage")
```
...
```{r}
#Bug
AllUserData <- AllUserData %>% select(-c(X1, X2, X3, X4, X5,X6, X7, X8))
